 ...
 * @author Rita
 */
public class CarreraR2 extends Thread {
    ...
    public CarreraR2(JLabel eti, frmauto p, int paintTime) {
        this.eti = eti;
        this.p = p;
         ...
         while (l == true) {
          ...
          while (t == true) {
            try {
                ...
                Logger.getLogger(CarreraR2.class.getName()).log(Level.SEVERE, null, ex);
            }
