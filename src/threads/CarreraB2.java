 ...
 * @author Rita
 */
public class CarreraB2 extends Thread {
    ...
    public CarreraB2(JLabel eti, frmauto p, int paintTime) {
        this.eti = eti;
        this.p = p;
    ...
    public void run() {
        ...
        while (t == true) {
            try {
                ...
                Logger.getLogger(CarreraB2.class.getName()).log(Level.SEVERE, null, ex);
            }
