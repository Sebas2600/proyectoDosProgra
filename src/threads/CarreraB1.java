 ...
 * @author Rita
 */
public class CarreraB1 extends Thread {
    ...
    public CarreraB1(JLabel eti, frmauto p, int paintTime) {
        this.eti = eti;
        this.p = p;
    ...
    public void run() {
        ...
        while (t == true) {
            try {
                ...
                Logger.getLogger(CarreraB1.class.getName()).log(Level.SEVERE, null, ex);
            }
